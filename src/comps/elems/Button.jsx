...
const Button = (props) => {
    ...
    return (
        <div id='lets' className='relative w-45'>
            <button onClick={gotoLink} className='w-full h-10 max-md:w-35  rounded-lg absolute max-md:text-xs !text-gray-800 !p-2 font-semibold flex items-center justify-center cursor-pointer'>
                {props.btn}
            </button>

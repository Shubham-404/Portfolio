                        ...
                        <div style={{ backgroundImage: `url(${item.image})` }} className="w-full inner-card bg-cover bg-center text-white rounded-xl overflow-hidden">
                            ...
                            <div className="!p-4 !px-10 bg-gradient-to-t from-black/95 to-black/60">
                                ...
                                <div className="btns w-full h-max bottom-0 flex justify-start">
                                    <button className="bg-gradient-to-r from-indigo-700 via-indigo-600 to-indigo-900 border-l-2 border-indigo-300 !px-4 !py-2 !m-2 rounded-full text-gray-50 cursor-pointer hover:scale-102 active:scale-97"><a className=" hover:!text-white  flex items-center gap-1"
                                        href={`${item.github}`} target="_blank"><h2>GitHub</h2> <img className="h-5 invert" src="/svgs/open.svg" alt="arrow" /></a></button>

                                    {item.url ?
                                        <button className="bg-gradient-to-r from-pink-700 via-pink-600 to-pink-900 border-l-2 border-pink-300 !px-4 !py-2 !m-2 rounded-full text-gray-50 cursor-pointer hover:scale-102 active:scale-97"><a className=" hover:!text-white  flex items-center gap-1"

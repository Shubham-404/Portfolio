  ...
  return (
    <div className="Intro !pt-10 grid justify-center items-center">
      ...
      <main className='justify-self-center !pb-10 max-w-7xl text-lg/20'>
        <h1 onClick={()=>{setNamaste("🙏")}} className='font-code font-semibold text-4xl !pb-5 max-lg:text-3xl max-md:text-2xl'>Namaste({Namaste}); I am</h1>
        <h1 className='name text-7xl font-bold font-hawk text-transparent max-lg:text-6xl max-md:text-5xl bg-clip-text inline'>Shubham.</h1>
